...
function App() {
  ...
  return (
    <div className="text-base flex flex-col h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 relative">
      <div className="p-5 text-lg font-semibold flex justify-between items-center bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div
        ...
        <div className="flex items-center">
          ...
          <div className="relative inline-block">
            <select
              ...
              className="appearance-none border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg text-base px-2 py-1 pr-8 cursor-pointer font-normal focus:outline-none"
            >
          ...
          <div className="flex items-center ml-6">
            <button
              ...
              className="p-2 rounded-lg border border-gray-300 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700 transition-colors focus:outline-none"
